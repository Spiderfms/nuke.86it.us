	...
	switch ( $mode )
	{
		...
		case 'reply':
			...
			if ( $error_msg == '' )
			{
				...
				submit_post($mode, $post_data, $return_message, $return_meta, $forum_id, $topic_id, $post_id, $poll_id, $topic_type, $bbcode_on, $html_on, $smilies_on, $attach_sig, $bbcode_uid, str_replace("\'", "''", (string) $username), str_replace("\'", "''", $subject), str_replace("\'", "''", (string) $message), str_replace("\'", "''", (string) $poll_title), $poll_options, $poll_length);
			}
			break;
