...
else if ( isset($_POST['group_update']) )
{
		...
		$group_name = isset($_POST['group_name']) ? htmlspecialchars(trim((string) $_POST['group_name'])) : '';
                $group_description = isset($_POST['group_description']) ? trim((string) $_POST['group_description']) : '';
