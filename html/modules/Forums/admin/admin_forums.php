...
if( !empty($mode) )
{
        switch($mode)
        {
                ...
                case 'createforum':
                        ...
                        //
                        if( trim((string) $_POST['forumname']) == "" )
                        {
                        ...
                        $sql = "INSERT INTO " . FORUMS_TABLE . " (forum_id, forum_name, cat_id, forum_desc, forum_order, forum_status, prune_enable" . $field_sql . ")
                                VALUES ('" . $next_id . "', '" . str_replace("\'", "''", (string) $_POST['forumname']) . "', " . intval($_POST[POST_CAT_URL]) . ", '" . str_replace("\'", "''", (string) $_POST['forumdesc']) . "', $next_order, " . intval($_POST['forumstatus']) . ", " . intval($_POST['prune_enable']) . $value_sql . ")";
                        if( !$result = $db->sql_query($sql) )
                        {
                ...
                case 'modforum':
                        ...
                        $sql = "UPDATE " . FORUMS_TABLE . "
                                SET forum_name = '" . str_replace("\'", "''", (string) $_POST['forumname']) . "', cat_id = " . intval($_POST[POST_CAT_URL]) . ", forum_desc = '" . str_replace("\'", "''", (string) $_POST['forumdesc']) . "', forum_status = " . intval($_POST['forumstatus']) . ", prune_enable = " . intval($_POST['prune_enable']) . "
                ...
                case 'addcat':
                        ...
                        if( trim((string) $_POST['categoryname']) == '')
                        {
                        ...
                        $sql = "INSERT INTO " . CATEGORIES_TABLE . " (cat_title, cat_order)
                                VALUES ('" . str_replace("\'", "''", (string) $_POST['categoryname']) . "', $next_order)";
                        if( !$result = $db->sql_query($sql) )
                        {
                ...
                case 'modcat':
                        ...
                        $sql = "UPDATE " . CATEGORIES_TABLE . "
                                SET cat_title = '" . str_replace("\'", "''", (string) $_POST['cat_title']) . "'
                                WHERE cat_id = " . intval($_POST[POST_CAT_URL]);
                        if( !$result = $db->sql_query($sql) )
                        {
                                message_die(GENERAL_ERROR, "Couldn't update forum information", "", __LINE__, __FILE__, $sql);
