...
define_once("_YOURNAME","Numele Dvs.");
...
define_once("_LINKTITLE","Titlul linkului");
define_once("_HITS","Vizite");
define_once("_THEREARE","Sunt");
define_once("_NOMATCHES","Nu au fost gasiti termeni potriviti cererii Dvs.");
define_once("_SCOMMENTS","Comentarii");
define_once("_DESCRIPTION","Descriere");
define_once("_DATE","Data");
define_once("_TO","Catre");
define_once("_ADDLINK","Adauga link");
define_once("_NEW","Nou");
define_once("_POPULAR","Popular");
define_once("_TOPRATED","Cele mai populare");
define_once("_RANDOM","aleator");
define_once("_LINKSMAIN","Pagina principala de linkuri");
define_once("_LINKCOMMENTS","Comentarii link");
define_once("_ADDITIONALDET","Detalii suplimentare");
define_once("_EDITORREVIEW","Recenzia editorului");
define_once("_REPORTBROKEN","Anunta un link nefunctional");
define_once("_LINKSMAINCAT","Categorii principale de linkuri");
define_once("_AND","si");
define_once("_INDB","in baza noastra de date");
define_once("_ADDALINK","Adauga link");
define_once("_INSTRUCTIONS","Instructiuni");
define_once("_SUBMITONCE","Trimite  un link doar o singura data.");
define_once("_POSTPENDING","Toate linkurile sunt verificate inainte de postare");
define_once("_USERANDIP","Numele de utilizator si IP-ul sunt inregistrate, asa ca va rugam nu abuzati de sistem.");
define_once("_PAGETITLE","Titlul paginii");
define_once("_PAGEURL","Page URL");
define_once("_YOUREMAIL","Email-ul Dvs.");
define_once("_LDESCRIPTION","Descriere: (255 caractere max)");
define_once("_ADDURL","Adauga acest URL");
define_once("_LINKSNOTUSER1","Nu sunteti utilizator inregistrat sau nu v-ati logat.");
define_once("_LINKSNOTUSER2","Daca sunteti inregistrat puteti adauga linkuri in acest website.");
define_once("_LINKSNOTUSER3","A deveni utilizator inregistrat este un proces usor si rapid.");
define_once("_LINKSNOTUSER4","De ce este necesara inregistrarea pentru accesul la anumite facilitati?");
define_once("_LINKSNOTUSER5","Doar asa va putem oferi continut de cea mai buna calitate,");
define_once("_LINKSNOTUSER6","fiecare item este verificat individual si aprobat de catre personalul nostru.");
define_once("_LINKSNOTUSER7","Speram sa va oferim doar informatii de valoare.");
define_once("_LINKSNOTUSER8","<a href=\"modules.php?name=Your_Account\">Inregistrati-va pentru a va crea un cont</a>");
define_once("_LINKALREADYEXT","EROARE: Acest URL este deja listat in baza de date!");
define_once("_LINKNOTITLE","EROARE: Trebuie sa scrieti un TITLU pentru URL-ul dvs.!");
define_once("_LINKNOURL","EROARE: Trebuie sa scrieti un URL !");
define_once("_LINKNODESC","EROARE: Trebuie sa scrieti o DESCRIERE pentru URL-ul dvs.");
define_once("_LINKRECEIVED","Am primit linkul trimis de Dvs. Multumim!");
define_once("_EMAILWHENADD","Veti primi un E-mail cand va fi aprobat.");
define_once("_CHECKFORIT","Nu ati furnizat o adresa de email dar vom verifica linkul dvs. curand.");
define_once("_NEWLINKS","Linkuri noi");
define_once("_TOTALNEWLINKS","Total Linkuri noi");
define_once("_LASTWEEK","Saptamana trecuta");
define_once("_LAST30DAYS","Ultimele 30 zile");
define_once("_1WEEK","1 Saptamana");
define_once("_2WEEKS","2 Saptamani");
define_once("_30DAYS","30 zile");
define_once("_SHOW","Arata");
define_once("_TOTALFORLAST","Total linkuri noi in ultimele");
define_once("_DAYS","zile");
define_once("_ADDEDON","Adaugate la");
define_once("_RATING","Apreciere");
define_once("_RATESITE","Apreciaza this Site");
define_once("_DETAILS","Detalii");
define_once("_BESTRATED","Cele mai apreciate linkuri - Top");
define_once("_OF","of");
...
define_once("_SORTLINKSBY","Sort Links by");
...
define_once("_CATNEWTODAY","New Links in this Category Added Today");
define_once("_CATLAST3DAYS","New Links in this Category Added in the last 3 days");
define_once("_CATTHISWEEK","New Links in this Category Added this week");
